...
const String GOOGLE_CLIENT_ID = "<GOOGLE_CLIENT_ID>";
// {USER_ONE <= 65, USER_TWO <= 100}
const String GOOGLE_REFRESH_TOKENS[] = {"GOOGLE_REFRESH_TOKENS_USER_ONE", "GOOGLE_REFRESH_TOKENS_USER_TWO"};
const int GOOGLE_REFRESH_TOKEN_WEIGHT_MAPPER[] = {65, 100};
const String GOOGLE_CLIENT_SECRET = "<GOOGLE_CLIENT_SECRET>";
///////////////////////
// Segment Display ////
///////////////////////
